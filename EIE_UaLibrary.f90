...
subroutine UA_GetHall(HallOut, iError)
  ...
  real, dimension(EIEi_HavenMlts,EIEi_HavenLats,EIEi_HavenBLKs) :: EIE_Value
  real, dimension(UAi_NeednMLTs,UAi_NeednLats)               :: ValueOut
  real, dimension(UAi_NeednMLTs,UAi_NeednLats), intent(out)  :: HallOut

  iError = 0

  if (UAl_UseGridBasedEIE) then

     EIE_Value = EIEr3_HaveHall

     call UA_GetValue(EIE_Value, ValueOut, 0.1, iError)

     if (iError /= 0) then
        write(*,*) "Error in routine UA_GetHall:"
        write(*,*) cErrorCodes(iError)
     else
        HallOut = ValueOut
     endif
     ...
     call UA_GetNonGridBasedHall(ValueOut, iError)
...
end subroutine UA_GetHall

!----------------------------------------------------------------------
!
!----------------------------------------------------------------------

subroutine UA_GetNonGridBasedHall(HallOut, iError)
  ...
  integer, intent(out) :: iError
  real, dimension(UAi_NeednMLTs,UAi_NeednLats) :: HallOut
  ...
  do iMLT = 1, UAi_NeednMLTs
     do iLat = 1, UAi_NeednLats
        ...
        HallOut(iMLT, iLat) = hal

     enddo
  enddo

end subroutine UA_GetNonGridBasedHall

!----------------------------------------------------------------------
!
!----------------------------------------------------------------------

subroutine UA_GetPed(PedOut, iError)
  ...
  real, dimension(EIEi_HavenMlts,EIEi_HavenLats,EIEi_HavenBLKs) :: EIE_Value
  real, dimension(UAi_NeednMLTs,UAi_NeednLats)               :: ValueOut
  real, dimension(UAi_NeednMLTs,UAi_NeednLats), intent(out)  :: PedOut

  iError = 0

  if (UAl_UseGridBasedEIE) then

     EIE_Value = EIEr3_HavePed
     call UA_GetValue(EIE_Value, ValueOut, 0.1, iError)

     if (iError /= 0) then
        write(*,*) "Error in routine UA_GetPed:"
        write(*,*) cErrorCodes(iError)
     else
        PedOut = ValueOut
     endif
     ...
     call UA_GetNonGridBasedPed(ValueOut, iError)
...
end subroutine UA_GetPed

!----------------------------------------------------------------------
!
!----------------------------------------------------------------------

subroutine UA_GetNonGridBasedPed(PedOut, iError)
  ...
  integer, intent(out) :: iError
  real, dimension(UAi_NeednMLTs,UAi_NeednLats) :: PedOut
  ...
  do iMLT = 1, UAi_NeednMLTs
     do iLat = 1, UAi_NeednLats
        ...
        PedOut(iMLT, iLat) = ped

     enddo
  enddo

end subroutine UA_GetNonGridBasedPed
